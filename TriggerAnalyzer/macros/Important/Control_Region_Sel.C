...
void Control_Region_Sel( int maxNentries=-1, int Njobs=1, int jobN=1 ) {
  ...
  for (Long64_t ievt=0; ievt<chain->GetEntries();ievt++) {    //Long64_t
		...
		if(pass_WPLoose_27==1) {
			...
			pt_WPLoose_27->Fill(vvLEPTON[lead][0]);
			pt2_WPLoose_27->Fill(vvLEPTON[sub_lead][0]);
			eta_WPLoose_27->Fill(vvLEPTON[lead][1]);
			phi_WPLoose_27->Fill(vvLEPTON[lead][2]);
		...
		if(pass_WPTight_27==1) {
			...
			pt_WPTight_27->Fill(vvLEPTON[lead][0]);
			pt2_WPTight_27->Fill(vvLEPTON[sub_lead][0]);
			eta_WPTight_27->Fill(vvLEPTON[lead][1]);
			phi_WPTight_27->Fill(vvLEPTON[lead][2]);
		...
		if(pass_WPTight_32==1) {
			...
			pt_WPTight_32->Fill(vvLEPTON[lead][0]);
			pt2_WPTight_32->Fill(vvLEPTON[sub_lead][0]);
			eta_WPTight_32->Fill(vvLEPTON[lead][1]);
			phi_WPTight_32->Fill(vvLEPTON[lead][2]);
		...
		if(pass_WPLoose_27_HT200==1) {
			...
			pt_WPLoose_27_HT200->Fill(vvLEPTON[lead][0]);
			pt2_WPLoose_27_HT200->Fill(vvLEPTON[sub_lead][0]);
			eta_WPLoose_27_HT200->Fill(vvLEPTON[lead][1]);
			phi_WPLoose_27_HT200->Fill(vvLEPTON[lead][2]);
		...
		if(pass_WPTight_27_OR_WPLoose_27_HT200==1) {
			...
			pt_WPTight_27_OR_WPLoose_27_HT200->Fill(vvLEPTON[lead][0]);
			pt2_WPTight_27_OR_WPLoose_27_HT200->Fill(vvLEPTON[sub_lead][0]);
			eta_WPTight_27_OR_WPLoose_27_HT200->Fill(vvLEPTON[lead][1]);
			phi_WPTight_27_OR_WPLoose_27_HT200->Fill(vvLEPTON[lead][2]);
