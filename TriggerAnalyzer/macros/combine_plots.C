...
void combine_plots() {
	...
	c1->DrawFrame(0,0.7,330,1.03,"MC ttH : Efficiency vs pT; pT (GeV) ; (Trigger_sel + Event_sel)/Event_sel");
	...
	c2->DrawFrame(-3,0.75,3,1.03,"MC ttH : Efficiency vs eta; #eta ; (Trigger_sel + Event_sel)/Event_sel");
	...
	c3->DrawFrame(-3,0.8,3,1.03,"MC ttH : Efficiency vs phi; #phi ; (Trigger_sel + Event_sel)/Event_sel");
	...
	c11->DrawFrame(0,0.7,330,1.03,"MC ttjets : Efficiency vs pT; pT (GeV) ; (Trigger_sel + Event_sel)/Event_sel");
	...
	c12->DrawFrame(-3,0.75,3,1.03,"MC ttjets : Efficiency vs eta; #eta ; (Trigger_sel + Event_sel)/Event_sel");
	...
	c13->DrawFrame(-3,0.8,3,1.03,"MC ttjets : Efficiency vs phi; #phi ; (Trigger_sel + Event_sel)/Event_sel");
	...
	c21->DrawFrame(0,0.7,330,1.03,"DATA : Efficiency vs pT; pT (GeV) ; (Trigger_sel + Event_sel)/Event_sel");
	...
	c22->DrawFrame(-3,0.75,3,1.03,"DATA : Efficiency vs eta; #eta ; (Trigger_sel + Event_sel)/Event_sel");
	...
	c23->DrawFrame(-3,0.8,3,1.03,"DATA : Efficiency vs phi; #phi ; (Trigger_sel + Event_sel)/Event_sel");
